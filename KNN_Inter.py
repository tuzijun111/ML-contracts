...
class RopEth():
    def __init__(self):
        ...
        self.contract_address = "0x390beE4e3F284D5ABCDD63Ea792Da1ED6f1D5878"  #linear regression sc
    ...
    def model_gas_cost(self, train, testrow, num_neighbors):
        ...
        estimatedGas1 = self.contract.functions.get_neighbors(train, testrow, num_neighbors).estimateGas()
        # print("Estimated gas to execute the transaction: ",estimatedGas)
        # print(dir(self.contract.functions.update(message)))
        txn_dict = self.contract.functions.get_neighbors(train, testrow, num_neighbors).buildTransaction({
            'gas': estimatedGas1,
...
if __name__ == '__main__':
    ...
    m.num_of_feature_run(dataset, num_feature, num_neighbors)
    # m.num_of_input_run(dataset, num_input, num_neighbors)

    
    # subset = dataset[:4]
    # testrow = dataset[1]

    # m.model_run(subset, testrow, num_neighbors)
